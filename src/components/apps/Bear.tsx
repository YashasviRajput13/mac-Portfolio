    ...
    <div className="text-white">
      ...
      <ul className="p-2">
        {bear.map((item, index) => (
          ...
          >
            <span className={`${item.icon} flex-shrink-0`} />
          ...
          <div className="ml-3 flex-1 min-w-0">
            <div className="flex items-center justify-between">
              ...
              {item.link && (
                ...
                >
                  <span className="i-ant-design:link-outlined" />
                </a>
              )}
            </div>
...
const Bear = () => {
  ...
  return (
    <div className="bear font-avenir flex h-full">
      <div className="w-48 overflow-auto bg-gray-700">
        <Sidebar cur={state.curSidebar} setMidBar={setMidBar} />
      </div>
      <div className="w-80 overflow-auto bg-gray-50 dark:bg-gray-800 border-r border-gray-300">
        <Middlebar
